#ifndef INCLUDED_MLK_TYPE_TRAITS_MONAD_HPP
#define INCLUDED_MLK_TYPE_TRAITS_MONAD_HPP
#include "core.hpp"
...
template <class X>
class is_monad {
#define DEF_HAS_ETA_FN(U) void_fn_t<U::template eta>
    DEF_ACCESSIBLE(DEF_HAS_ETA_FN, has_eta);
#undef DEF_HAS_ETA_FN
#define DEF_HAS_BIND_FN(U) void_fn_t<U::template bind>
